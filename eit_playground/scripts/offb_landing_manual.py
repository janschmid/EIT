...
class offb_landing:
    ...
    * get_state:
    ...
    def calculate_xy_to_aruco_marker(self):
        ...
        rospy.loginfo("cX: {0}, cY: {1},    aX: {2}, aY: {3},   tX: {4}, tY: {5}".format(self.positionX, self.positionY, aruco_y_rotated, aruco_x_rotated, x,y))
        return x,y
    ...
    def calculate_rotation_to_marker(self):
        ...
        rospy.loginfo("Rot: aruco: {0}, drone: {1}, target: {2}".format(e_aruco[2], e_drone[2], e_target[2]))
        return r_target
